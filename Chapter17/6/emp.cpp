...
void abstr_emp::WriteAll(ofstream &fout) { fout << fname << " " << lname << " " << job; }
...
void abstr_emp::GetAll(ifstream &fin) { fin >> fname >> lname >> job; }
void employee::GetAll(ifstream &fin) { abstr_emp::GetAll(fin); }
void manager::GetAll(ifstream &fin) { abstr_emp::GetAll(fin); fin >> inchargeof; }
void fink::GetAll(ifstream &fin) { abstr_emp::GetAll(fin); fin >> reportsto; }
void highfink::GetAll(ifstream &fin) { abstr_emp::GetAll(fin); fin >> InChargeOf(); fin >> ReportsTo(); }
